void RegisterAllStrippedInternalCalls()
{
	...
	//Start Registrations for type : UnityEngine.AI.OffMeshLink

		//System.Int32 UnityEngine.AI.OffMeshLink::get_area()
		void Register_UnityEngine_AI_OffMeshLink_get_area();
		Register_UnityEngine_AI_OffMeshLink_get_area();

		//UnityEngine.Transform UnityEngine.AI.OffMeshLink::get_endTransform()
		void Register_UnityEngine_AI_OffMeshLink_get_endTransform();
		Register_UnityEngine_AI_OffMeshLink_get_endTransform();

		//UnityEngine.Transform UnityEngine.AI.OffMeshLink::get_startTransform()
		void Register_UnityEngine_AI_OffMeshLink_get_startTransform();
		Register_UnityEngine_AI_OffMeshLink_get_startTransform();

	//End Registrations for type : UnityEngine.AI.OffMeshLink

	//Start Registrations for type : UnityEngine.AI.OffMeshLinkData

		//UnityEngine.AI.OffMeshLink UnityEngine.AI.OffMeshLinkData::GetOffMeshLinkInternal(System.Int32)
		void Register_UnityEngine_AI_OffMeshLinkData_GetOffMeshLinkInternal();
		Register_UnityEngine_AI_OffMeshLinkData_GetOffMeshLinkInternal();

	//End Registrations for type : UnityEngine.AI.OffMeshLinkData
	...
	//Start Registrations for type : UnityEngine.Playables.PlayableDirector
		...
		void Register_UnityEngine_Playables_PlayableDirector_GetPlayOnAwake();
		Register_UnityEngine_Playables_PlayableDirector_GetPlayOnAwake();
